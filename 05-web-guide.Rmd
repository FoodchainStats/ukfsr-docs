...
this process will extract the PNG graphics from each Word document and place them in a separately created /images/media folder as .png files, leaving behind just a placeholder for the graphic in the text, e.g. 
```
