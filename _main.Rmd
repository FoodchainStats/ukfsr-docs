...
to add/change? Go [here](https://github.com/FoodchainStats/ukfsr-docs/issues),
...
- The [`ukfsr`](https://github.com/FoodchainStats/ukfsr) R package containing miscellanous helper functions
- This documentation
...
<!--chapter:end:01-text-style-guide.Rmd-->
...
The `ukfsr` package contains functions to assist with preparing the report. See
[link to repo/docs] for details. There is a `theme_ukfsr` theme for chart
...
<!--chapter:end:02-chart-style-guide.Rmd-->
...
<!--chapter:end:04-theme-guide.Rmd-->
...
<!--chapter:end:06-print-guide.Rmd-->
...
<!--chapter:end:07-appendix-misc.Rmd-->
