...
The UKFSR is more than just a single document. It has a number of components as part of its underlying infrastructure:
...
- the report on gov.uk (this is the UKFSR to all intents and purposes for the public)
- the physical printed edition laid in the HoC Library
